...
import { ordersData } from "@mypages/SECT4";
...
const SysAnalysis = () => {
  ...
  const DATE_FILTERS = ["Days", "Weeks", "Months", "Years"];

  const CUMULATIVES = [
    { title: "Total Expenses", amount: "N18900", icon: "/total_orders.svg" },
    { title: "Total Orders", amount: "9100", icon: "/total_cust.svg" },
    { title: "Total Revenue", amount: "N90,0000", icon: "/total_rev.svg" },
    { title: "Total Customers", amount: "9100", icon: "/total_cust.svg" },
    { title: "Total Staffs", amount: "18900", icon: "/total_orders.svg" },
    { title: "Total Supplied", amount: "N90,0000", icon: "/total_rev.svg" },
  ];
  ...
  return (
    <Wrapper className="_flex_col _gap30 _full_h">
      <PagesMainLayout
        title={
          <p className="_flex _align_center">
            <img src="/analysis.svg" alt="" />
            <span>Analysis {" >> "} System Analysis</span>
          </p>
        }
        mainContent={
          <div>
            <section className="date_filter _flex_jcsb _wrap _gap20">
              <div className="div1 _max_h _align_center _bg_white _gap15 _flex">
              ...
              <div className="div2 _max_h _margin_left_auto _bg_white _flex_center _gap15">
